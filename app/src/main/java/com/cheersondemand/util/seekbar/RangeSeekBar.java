package com.cheersondemand.util.seekbar;
...
public class RangeSeekBar <T extends Number> extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.drawable.red_circle;
        int thumbPressed = R.drawable.red_circle;
        int thumbDisabled = R.drawable.red_circle;
       ...
       /* mThumbHalfWidth = 0.5f * thumbImage.getWidth();
        ...
        mThumbHalfWidth = 0.5f * 50;
        mThumbHalfHeight = 0.5f * 50;
