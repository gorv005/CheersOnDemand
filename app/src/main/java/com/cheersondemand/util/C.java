...
public interface C {
   ...
   String MAX_RANGE = "maxRange";
    ...
    String TAG_FRAGMENT_SEARCH_PRODUCTS ="TAG_FRAGMENT_SEARCH_PRODUCTS" ;
    ...
    String IS_STORE_UPDATED_HOME ="IS_STORE_UPDATED_HOME" ;
    int FRAGMENT_ADDRESS_PICKUP_DELIVERY_SELECTION = 40;
    String GOOGLE_API_CLIENT_ID = "GOOGLE_API_CLIENT_ID";
}
