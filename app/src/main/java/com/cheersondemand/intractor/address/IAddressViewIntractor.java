...
public interface IAddressViewIntractor {
    ...
    public void AddAddress(boolean isAuth,String token, String userId, AddressRequest addressRequest, OnFinishedListener listener);
    public void EditAddAddress(boolean isAuth,String token, String userId,String id, AddressRequest addressRequest, OnFinishedListener listener);
    public void getAddresses(boolean isAuth,String token,String userId, String uuid, OnFinishedListener listener);
    public void RemoveAddAddress(boolean isAuth, String token, String userId, String id, RemoveAddressRequest removeAddressRequest, OnFinishedListener listener);
